...
(~20 prompts total). `beats` is the suggested beat count for the planner.
...
| # | topic (ar) | topic (en) | term | unit | visual concept | example numbers | beats | digits note | difficulty |
|---|------------|------------|------|------|----------------|-----------------|-------|-------------|------------|
| 18 | محيط المستطيل والمربع | ★ Perimeter of a rectangle and a square | 2 | Geometry | An ant walks the rectangle border leaving a traced outline; side labels tick off in the sum | محيط مستطيل طوله ٦ وعرضه ٤ | 3 | Western digits | easy |
| 19 | ★ مساحة المستطيل والمربع | ★ Area of a rectangle as a grid of unit squares | 2 | Geometry | A 6×4 rectangle fills with unit squares row by row; the rows collapse into the multiplication 6 × 4 = 24 | مساحة مستطيل طوله ٦ وعرضه ٤ | 3 | Western digits | easy |
| 20 | ★ تحويل وحدات القياس | ★ Converting metric length units | 2 | Measurement | A 1-meter ruler unfolds into ten 10-cm segments; unit labels swap (م ← سم) | حوّل ٣ متر إلى سنتيمتر | 3 | Western digits | medium |
